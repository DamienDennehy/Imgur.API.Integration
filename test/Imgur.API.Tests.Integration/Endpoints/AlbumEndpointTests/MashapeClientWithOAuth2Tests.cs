...
namespace Imgur.API.Tests.Integration.Endpoints.AlbumEndpointTests
{
    public class MashapeClientWithOAuth2Tests : TestBase
    {
        ...
        public async Task RemoveAlbumImagesAsync_WithAlbum_Equal(IAlbum actualAlbum)
        {
            ...
            var updated =
                await
                    endpoint.RemoveAlbumImagesAsync(actualAlbum.Id, new List<string> {"KM5gQeJ", "VzbrLbO"})
        ...
        public async Task SetAlbumImagesAsync_WithAlbum_Equal(IAlbum actualAlbum)
        {
            ...
            var updated =
                await
                    endpoint.SetAlbumImagesAsync(actualAlbum.Id, new List<string> {"KM5gQeJ", "OkFyVOe", "Y8BbQuU"})
                        .ConfigureAwait(false);
